  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience a new era of convenience with Construction Tool Rental - Your one-stop shop for renting construction tools from multiple outlets, tailored for individuals."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience a new era of convenience with Construction Tool Rental - Your one-stop shop for renting construction tools from multiple outlets, tailored for individuals.`}
            </Text>
            <Box
